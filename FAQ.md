...
Find a publicly available stream using your favourite search engine or by searching GitHub. Just don't forget to carefully read the "Stream Validation" section in the [Contributing Guide](https://github.com/iptv-org/iptv/blob/master/CONTRIBUTING.md#stream-validation) first.


### Why isn't my link accepted?

See the "Link Requirements" and "Stream Validation" sections of the [Contributing Guide](https://github.com/iptv-org/iptv/blob/master/CONTRIBUTING.md#Requirements#link-requirements)
