...
Most stations can be accessed without issues (see the Resources section if your are using IPTV for first time). Some of them are hybrid radio stations (also called "visual radio"). Some channels are streaming in high resolution (720p, 1080p, 2160p or more) and requires a fast connection (this means that if you have a slow connection, you might experience stutters and/or signal loss).
