...
Most stations can be accessed without lag (see the Resources section if your are using IPTV for first time). Some of them are hybrid radio stations (also called "visual radio"). But few channels are streaming in high resolution (720p, 1080p, 2160p or more) that work better with a stable network.
