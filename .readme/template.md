...
Internet Protocol television (IPTV) is the delivery of television content over Internet Protocol (IP) networks. This repository has a community database for compile into organized and ready-to-use playlists the available IPTV stations, regardless of their local or international scope.
